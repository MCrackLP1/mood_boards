    ...
    return (
        <Link href={`/board/${board.id}`} className="group relative block aspect-square">
            ...
            <button 
                ...
                className="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-sm rounded-full text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white hover:text-red-500 focus:opacity-100"
